    ...
    return (
        <main>
            <Section id="hero">
                <div className="wrapper hero_wrapper">
                    <div className="left_content">
                        ...
                        <h1>
                            The best way to learn something is to build
                            something
                        </h1>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Impedit, ipsam. Odit reprehenderit quam fuga.
                            Quas eligendi atque esse consequatur ducimus?
                        </p>
                        <form>
            ...
            <Section id="tutorials">
                ...
                />
                <Slider slideData={tutsData} slideView={3} space={20} />
            </Section>
            ...
            <Section id="features">
                <div className="wrapper features_wrapper">
                    ...
                    <div className="right_content">
                        <h6>Core features</h6>
                        <h2>
                            Smart Jackpots that you may love this anytime &
                            anywhere
                        </h2>
                        <p>
                            Lorem ipsum dolor sit amet consectetur, adipisicing
                            elit. Et minus voluptate modi illum veritatis
                            consequuntur aperiam a eius quod error.
                        </p>
            ...
            <Section id="free_tut">
                <div className="wrapper free_tut_wrapper">
                    ...
                    <div className="right_content">
                        <h6>Free tutorial</h6>
                        <h2>
                            More than thousand of free tutorial upload every
                            weeks
                        </h2>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Inventore pariatur totam molestiae deleniti.
                            Nemo rerum earum cupiditate ducimus incidunt quam.
                        </p>
                        <button className="btn">Explore details</button>
                    </div>
                </div>
